...
class ControllerCatalogAttribute extends Controller {
	...
	protected function getList() {
		...
		$data['sort_featured'] = $this->url->link('catalog/attribute', 'user_token=' . $this->session->data['user_token'] . '&sort=a.featured' . $url, true);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['sort_order'])) {
			...
			$data['featured'] = $attribute_info['featured'];
		} else {
			$data['featured'] = '';
		}
