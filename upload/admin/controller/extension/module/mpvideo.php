...
class ControllerExtensionModuleMpvideo extends Controller {
	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link($this->extension_path . 'module/mpvideo', $this->token.'=' . $this->session->data[$this->token] . '&module_id=' . $this->request->get['module_id'], true)
			);
		}
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link($this->extension_path . 'module/mpvideo', $this->token.'=' . $this->session->data[$this->token], true);
		} else {
			$data['action'] = $this->url->link($this->extension_path . 'module/mpvideo', $this->token.'=' . $this->session->data[$this->token] . '&module_id=' . $this->request->get['module_id'], true);
		}
		...
		} elseif (isset($module_info['video_description'])) {
		...
		$this->response->setOutput($this->viewLoad($this->extension_path . 'module/mpvideo', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', $this->extension_path . 'module/mpvideo')) {
