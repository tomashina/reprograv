        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bestseller" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane <?php echo $tab_general_class; ?>" id="tab-general">
				  ...
				  <div class="form-group">
					<label class="col-sm-2 control-label" for="input-module_client_translate_expert_show_char_count_globally"><?php echo $entry_server_show_translation_char_count_globally; ?></label>
					<div class="col-sm-10">
					  <input type="checkbox" name="module_client_translate_expert_show_char_count_globally" value="1" id="input-module_client_translate_expert_show_char_count_globally" <?php echo $module_client_translate_expert_show_char_count_globally == 1 ? 'checked="1"' : ''; ?>/> <?php echo $entry_server_show_translation_char_count_globally; ?>
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-sm-2 control-label" for="input-module_client_translate_expert_reset_char_count_on_start_month"><?php echo $entry_server_reset_translation_char_count_on_start_month; ?></label>
					<div class="col-sm-10">
					  <input type="checkbox" name="module_client_translate_expert_reset_char_count_on_start_month" value="1" id="input-module_client_translate_expert_reset_char_count_on_start_month" <?php echo $module_client_translate_expert_reset_char_count_on_start_month == 1 ? 'checked="1"' : ''; ?> /> <?php echo $entry_server_reset_translation_char_count_on_start_month; ?>
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-sm-2 control-label" for="input-module_client_translate_expert_char_count"><?php echo $entry_server_translation_char_count; ?></label>
					<div class="col-sm-10">
					  <div name="module_client_translate_expert_char_count" id="input-module_client_translate_expert_char_count">
						<?php echo $module_client_translate_expert_char_count ? $module_client_translate_expert_char_count : 0; ?>
					  </div>
					</div>
				  </div>
				  <div class="form-group">
				...
				<div class="tab-pane <?php echo $tab_debug_class; ?>" id="tab-debug">
				  ...
				  <div class="form-group">
						<label class="col-sm-2 control-label" for="license_info_active"><?php echo $entry_license_info . ' - Active'; ?></label>
						<div class="col-sm-10">
							<strong name="license_info_active" id="license_info_active" class="form-control"><?php echo $license_info->active; ?></strong>
						</div>
				  </div>
				  <div class="form-group">
						<label class="col-sm-2 control-label" for="license_info_licensed"><?php echo $entry_license_info . ' - Licensed'; ?></label>
						<div class="col-sm-10">
							<strong name="license_info_licensed" id="license_info_licensed" class="form-control"><?php echo $license_info->licensed; ?></strong>
						</div>
				  </div>
				  <div class="form-group">
