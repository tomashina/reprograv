...
*/
$_['text_checkout_payment_note'] = "Notice: fill out the form manually";
$_['text_recurring'] = "Recurring items";
$_['text_payment_until_canceled_description'] = "%s every %d %s(a) until cancelled";
$_['text_login'] = "Sign up";
$_['text_review'] = "Check order";
$_['entry_fax'] = "Fax";
$_['error_custom_field_validate'] = "%s is invalid data!";