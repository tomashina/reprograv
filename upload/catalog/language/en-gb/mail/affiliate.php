...
*/
$_['text_services'] = "After signing up (login), you will be able to generate tracking codes, track commission payments, and update your affiliate account information.";
$_['text_store'] = "Trade:";
$_['text_order_id'] = "Order number:";
$_['text_transaction_subject'] = "%s - affiliate commission";
$_['text_transaction_received'] = "You have received %s commissions!";
$_['text_transaction_total'] = "Your total commission amount is now %s.";