...
class ControllerExtensionPaymentWSPay extends Controller {
  public function index() {
    ...
    $data['cancel_url'] = $this->url->link('extension/payment/wspayfail', '', true);
    ...
    //print_r($posted);
      ...
      // Variables for readability
                ...
                $WsPayOrderId = $posted['WsPayOrderId'];

                $DateTime = $posted['DateTime'];

                $returndata = array($WsPayOrderId,$DateTime,$ApprovalCode);
        ...
        if( ($posted['Success'] == 1) && (!empty($posted['ApprovalCode'])) && ($hash == $posted['Signature']) ) {
            ...
            $this->response->redirect($this->url->link('extension/payment/wspaysuccess', $returndata, 'SSL'));
            ...
            $this->response->redirect($this->url->link('extension/payment/wspayfail', '', 'SSL'));
        }
    }
