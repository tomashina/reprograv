...
class ControllerExtensionModuleBaselCarousel extends Controller {
	public function index($setting) {
			...
			$this->document->addScript('catalog/view/theme/basel/js/lightgallery/js/lightgallery.min.js');

$this->document->addScript('catalog/view/theme/basel/js/lightgallery/js/lg-zoom.min.js');

$this->document->addScript('catalog/view/theme/basel/js/cloudzoom/cloud-zoom.1.0.2.min.js');
