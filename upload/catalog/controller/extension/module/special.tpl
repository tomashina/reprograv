    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div class="row main-products product-list" data-grid-classes="<?php echo $this->journal2->settings->get('product_grid_classes'); ?> display-<?php echo $this->journal2->settings->get('product_grid_wishlist_icon_display'); ?> <?php echo $this->journal2->settings->get('product_grid_button_block_button'); ?>">
        <?php foreach ($products as $product) { ?>     
                ...
                <div class="product-grid xs-100 sm-100 md-100 lg-100 xl-100">
          ...
          <div class="product-thumb <?php echo isset($product['labels']) && is_array($product['labels']) && isset($product['labels']['outofstock']) ? 'outofstock' : ''; ?>">
            ...
            <div class="product-details">
              ...
              <div class="button-group">
               ...
               <?php if ($product['price'] != $request_texts['request_language_price'] ) { ?>
                ...
                <?php } else { ?>
                    <a onclick="mmoscart.add('<?php echo $product['product_id']; ?>');" class="button hint--top" data-hint="<?php echo $request_texts['request_language_button']; ?>"><?php echo html_entity_decode($request_texts['icon_button_request']);?> <span class="button-cart-text"><?php echo $request_texts['request_language_button'] ?></span></a>
                <?php } ?>
