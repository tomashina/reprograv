...
if (!empty($this->request->get['path'])) {
    $base_path = (string)$this->request->get['path'];
} elseif (!empty($this->category_id)) {
    $base_path = (string)$this->category_id;
}
        ...
        foreach ($sub_categories as $sub_category) {
           ...
           // formiraj path za link: base_path + '_' + child ili samo child
$href_path = $base_path ? ($base_path . '_' . (int)$sub_category['category_id']) : (int)$sub_category['category_id'];

// SEO-friendly link
$href = $this->url->link('product/category', 'path=' . $href_path);
